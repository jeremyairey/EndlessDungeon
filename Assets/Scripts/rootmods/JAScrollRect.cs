...
{
    [AddComponentMenu("UI/JAScroll Rect", 37)]
    [SelectionBase]
    [ExecuteInEditMode]
    [DisallowMultipleComponent]
    [RequireComponent(typeof(RectTransform))]
    public class JAScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            var pointerDelta = localCursor - m_PointerStartLocalCursor;
            pointerDelta *= m_ScrollFactor;   //JWA
